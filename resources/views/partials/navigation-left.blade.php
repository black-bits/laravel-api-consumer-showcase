<div class="navigation-left">
    <ul class="list-unstyled bg-white border px-3 rounded">
        ...
        <li><a class="{{ Route::currentRouteName() == 'symbols.show'         ? 'active' : '' }} d-block py-1 pl-3 pr-2 my-1" href="{{ route('symbols.show', 'AAPL')         }}">Show One Symbol</a></li>
        <li><a class="{{ Route::currentRouteName() == 'symbols.show.company' ? 'active' : '' }} d-block py-1 pl-3 pr-2 my-1" href="{{ route('symbols.show.company', 'AAPL') }}">Show Comapny For Symbol</a></li>
        ...
        <li><a class="{{ Route::currentRouteName() == 'comments.list' ? 'active' : '' }} d-block py-1 pl-3 pr-2 my-1" href="{{ route('comments.list') }}">List Comments</a></li>
